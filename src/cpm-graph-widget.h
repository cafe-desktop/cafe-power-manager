...
#define CPM_GRAPH_WIDGET(obj)		(G_TYPE_CHECK_INSTANCE_CAST ((obj), CPM_TYPE_GRAPH_WIDGET, GpmGraphWidget))
#define CPM_GRAPH_WIDGET_CLASS(obj)	(G_TYPE_CHECK_CLASS_CAST ((obj), CPM_GRAPH_WIDGET, GpmGraphWidgetClass))
...
#define CPM_GRAPH_WIDGET_GET_CLASS	(G_TYPE_INSTANCE_GET_CLASS ((obj), CPM_TYPE_GRAPH_WIDGET, GpmGraphWidgetClass))
